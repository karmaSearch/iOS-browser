...
extension String {
    ...
    public static let AppMenuTurnOffNightModeStatus = MZLocalizedString("Menu.NightModeTurnOff.Status", value: "Invert website colors", comment: "Label for the button, displayed in the menu, turns off night mode.", lastUpdated: .unknown)
    ...
    public static let AppMenuNoImageStatus = MZLocalizedString("Menu.NoImageModeBlockImages.Status", value: "Do not display images on sites", comment: "Label for the button, displayed in the menu, hides images on the webpage when pressed.", lastUpdated: .unknown)
