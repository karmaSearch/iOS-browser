...
fileprivate class DarkTableViewColor: TableViewColor {
    ...
    override var headerTextDark: UIColor { return UIColor.Photon.White100 }
...
fileprivate class DarkHomePanelColor: HomePanelColor {
    ...
    override var shortcutBackground: UIColor { return UIColor(rgb: 0x424448) }

    override var shortcutShadowColor: CGColor { return UIColor(red: 0, green: 0, blue: 0, alpha: 0.1).cgColor }
