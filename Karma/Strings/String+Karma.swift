...
extension String {
    ...
    //MARK: Learn and Act
    public static let LearnAndActSubTitle = NSLocalizedString("learnandact_subtitle", tableName: "Karma", bundle: Bundle(for: BundleClass.self), comment: "")
    ...
    public static let SearchSuggestionHeader = NSLocalizedString("KARMA Search", tableName: "Karma", comment: "Search suggestions header")
